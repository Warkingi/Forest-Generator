...
Window::Window():windowPtr(nullptr), winRect(), glContext(nullptr), isInitialized(false), isFullScreen(true) {
...
bool Window::OnCreate() {
	...
	windowPtr = SDL_CreateWindow("Noah's Forest Generator", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 
